...
func (r *creationRepo) ArticleCreateReviewPass(ctx context.Context, id int32, uuid string) error {
...
func (r *creationRepo) CreateArticleCacheAndSearch(ctx context.Context, id int32, uuid string) error {
