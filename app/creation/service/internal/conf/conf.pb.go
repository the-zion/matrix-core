...
type Data_CreationMq struct {
	...
	ArticleDraft  *Data_CreationMq_ArticleDraft `protobuf:"bytes,1,opt,name=articleDraft,proto3" json:"articleDraft,omitempty"`
...
func (x *Data_CreationMq) GetArticleDraft() *Data_CreationMq_ArticleDraft {
	if x != nil {
...
type Data_CreationMq_ArticleDraft struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Data_CreationMq_ArticleDraft) Reset() {
	*x = Data_CreationMq_ArticleDraft{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_CreationMq_ArticleDraft) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_CreationMq_ArticleDraft) ProtoMessage() {}

func (x *Data_CreationMq_ArticleDraft) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_CreationMq_ArticleDraft.ProtoReflect.Descriptor instead.
func (*Data_CreationMq_ArticleDraft) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 4, 0}
}

func (x *Data_CreationMq_ArticleDraft) GetGroupName() string {
	if x != nil {
		return x.GroupName
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x91, 0x09, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	...
	0x1a, 0x88, 0x02, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x71, 0x12,
	0x4c, 0x0a, 0x0c, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x44, 0x72, 0x61, 0x66, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x28, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x4d, 0x71, 0x2e, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x44, 0x72, 0x61, 0x66, 0x74, 0x52,
	0x0c, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x44, 0x72, 0x61, 0x66, 0x74, 0x12, 0x24, 0x0a,
	...
	0x28, 0x09, 0x52, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x53, 0x70, 0x61, 0x63, 0x65, 0x1a, 0x2c, 0x0a,
	0x0c, 0x41, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x44, 0x72, 0x61, 0x66, 0x74, 0x12, 0x1c, 0x0a,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_CreationMq_ArticleDraft)(nil),   // 11: kratos.api.Data.CreationMq.ArticleDraft
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	11, // 14: kratos.api.Data.CreationMq.articleDraft:type_name -> kratos.api.Data.CreationMq.ArticleDraft
...
func file_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_conf_conf_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Data_CreationMq_ArticleDraft); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
