...
type Data_Rocketmq struct {
	...
	Article       *Data_Rocketmq_Article `protobuf:"bytes,1,opt,name=article,proto3" json:"article,omitempty"`
...
func (x *Data_Rocketmq) GetArticle() *Data_Rocketmq_Article {
	if x != nil {
		return x.Article
	}
	return nil
...
type Data_Rocketmq_Article struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Data_Rocketmq_Article) Reset() {
	*x = Data_Rocketmq_Article{}
	if protoimpl.UnsafeEnabled {
...
func (x *Data_Rocketmq_Article) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Rocketmq_Article) ProtoMessage() {}

func (x *Data_Rocketmq_Article) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Rocketmq_Article.ProtoReflect.Descriptor instead.
func (*Data_Rocketmq_Article) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 3, 0}
}

func (x *Data_Rocketmq_Article) GetGroupName() string {
	if x != nil {
		return x.GroupName
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xa0, 0x06, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	...
	0x63, 0x72, 0x65, 0x74, 0x4b, 0x65, 0x79, 0x1a, 0xf0, 0x01, 0x0a, 0x08, 0x52, 0x6f, 0x63, 0x6b,
	0x65, 0x74, 0x6d, 0x71, 0x12, 0x3b, 0x0a, 0x07, 0x61, 0x72, 0x74, 0x69, 0x63, 0x6c, 0x65, 0x18,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e, 0x61, 0x6d, 0x65, 0x53, 0x70, 0x61, 0x63,
	...
	0x09, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x4e, 0x61, 0x6d, 0x65, 0x42, 0x24, 0x5a, 0x22, 0x6d, 0x65,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Rocketmq_Article)(nil), // 9: kratos.api.Data.Rocketmq.Article
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	9,  // 12: kratos.api.Data.Rocketmq.article:type_name -> kratos.api.Data.Rocketmq.Article
...
func file_conf_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_conf_conf_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Data_Rocketmq_Article); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
